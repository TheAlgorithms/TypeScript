...
var coPrime = function (numbers) {
    ...
    for (var i = 2; i <= Math.sqrt(numbers[0]); i++) {
        if (numbers[0] % i == 0) {
            factors0.push(i);
        }
    }
    for (var i = 2; i <= Math.sqrt(numbers[1]); i++) {
        if (numbers[1] % i == 0) {
            factors1.push(i);
        }
    }
    ...
    for (var i = 0; i <= factors0.length; i++) {
