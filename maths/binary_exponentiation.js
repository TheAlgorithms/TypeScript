...
exports.binaryExponent = void 0;
var binaryExponent = function (numbers) {
    ...
    var res = Math.pow(numbers[0], Math.floor(numbers[1] / 2));
    // if B is even or odd
    if (numbers[1] % 2 === 1) {
...
exports.binaryExponent = binaryExponent;
