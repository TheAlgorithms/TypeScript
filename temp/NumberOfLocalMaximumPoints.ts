...
const IsMaximumPoint = (array: Array<number>, index: number): boolean => {
  // handle array bounds
  // array start
  if (index === 0) {
...
const CountLocalMaximumPoints = (
  ...
  const middleIndex = Number((startIndex + endIndex) / 2);
  return (
...
const NumberOfLocalMaximumPoints = (A: Array<number>) =>
